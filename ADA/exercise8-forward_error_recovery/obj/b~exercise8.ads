...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_exercise8" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5affb482#;
   pragma Export (C, u00001, "exercise8B");
   ...
   u00162 : constant Version_32 := 16#ec38a9a5#;
   pragma Export (C, u00162, "system__concat_7B");
   u00163 : constant Version_32 := 16#3fb60411#;
   pragma Export (C, u00163, "system__concat_7S");
   u00164 : constant Version_32 := 16#7268f812#;
   pragma Export (C, u00164, "system__img_boolB");
   u00165 : constant Version_32 := 16#d63886e0#;
   ...
   u00172 : constant Version_32 := 16#7a9a5f5e#;
   pragma Export (C, u00172, "system__tasking__protected_objects__entriesB");
   u00173 : constant Version_32 := 16#a416dd28#;
   pragma Export (C, u00173, "system__tasking__protected_objects__entriesS");
   u00174 : constant Version_32 := 16#4d3e0469#;
   pragma Export (C, u00174, "system__tasking__initializationB");
   u00175 : constant Version_32 := 16#7f6b69f1#;
   pragma Export (C, u00175, "system__tasking__initializationS");
   u00176 : constant Version_32 := 16#9fcca227#;
   pragma Export (C, u00176, "system__tasking__protected_objects__operationsB");
   u00177 : constant Version_32 := 16#eb309cf0#;
   pragma Export (C, u00177, "system__tasking__protected_objects__operationsS");
   u00178 : constant Version_32 := 16#b59e6e78#;
   pragma Export (C, u00178, "system__tasking__entry_callsB");
   u00179 : constant Version_32 := 16#687efea4#;
   pragma Export (C, u00179, "system__tasking__entry_callsS");
   u00180 : constant Version_32 := 16#88081561#;
   pragma Export (C, u00180, "system__tasking__queuingB");
   u00181 : constant Version_32 := 16#ee1cad28#;
   pragma Export (C, u00181, "system__tasking__queuingS");
   u00182 : constant Version_32 := 16#f488ba38#;
   pragma Export (C, u00182, "system__tasking__utilitiesB");
   u00183 : constant Version_32 := 16#0ef27416#;
   pragma Export (C, u00183, "system__tasking__utilitiesS");
   u00184 : constant Version_32 := 16#bd6fc52e#;
   pragma Export (C, u00184, "system__traces__taskingB");
   u00185 : constant Version_32 := 16#becc801d#;
   pragma Export (C, u00185, "system__traces__taskingS");
   u00186 : constant Version_32 := 16#959cf892#;
   pragma Export (C, u00186, "system__tasking__rendezvousB");
   u00187 : constant Version_32 := 16#d056c48f#;
   pragma Export (C, u00187, "system__tasking__rendezvousS");
   u00188 : constant Version_32 := 16#14757b6f#;
   pragma Export (C, u00188, "system__tasking__stagesB");
   u00189 : constant Version_32 := 16#84f88b56#;
   pragma Export (C, u00189, "system__tasking__stagesS");
   u00190 : constant Version_32 := 16#57a37a42#;
   pragma Export (C, u00190, "system__address_imageB");
   u00191 : constant Version_32 := 16#820d6a31#;
   pragma Export (C, u00191, "system__address_imageS");
   u00192 : constant Version_32 := 16#0936cab5#;
   pragma Export (C, u00192, "system__memoryB");
   u00193 : constant Version_32 := 16#e96a4b1e#;
